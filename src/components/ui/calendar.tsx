...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 rounded-lg bg-popover border border-border shadow-xl", className)}
      classNames={{
        months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center mb-3 pb-2 border-b border-border/50",
        ...
        day_selected:
          "bg-orange-500/80 text-white hover:bg-orange-500 hover:text-white focus:bg-orange-500 focus:text-white font-semibold",
